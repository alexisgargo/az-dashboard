...
export default function TotalProgress(prop: { releaseInfo: release }) {
  ...
  return (
    <div>
      ...
      <p>Release date: {prop.releaseInfo.end_release_date}</p>
      <p>Release engineer: {prop.releaseInfo.engineer}</p>
      {prop.releaseInfo.is_hotfix ? (
        <p>Hotfix</p>
      ) : (<></>)}
      {prop.releaseInfo.is_rollback ? (
        <p>Rolled back</p>
      ) : (<></>)}
