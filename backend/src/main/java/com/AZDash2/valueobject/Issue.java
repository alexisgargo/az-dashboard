...
public class Issue {
    ...
    public Issue(String key, String status, String description, String creator, String summary, String assignee, String created, String resolved, String version,String comment) {
        this.key = key;
        this.status = status;
